...
x_train_origin = np.load('D:/lotte_data/npy/brandnew_1000plus_data.npy')
y_train_origin = np.load('D:/lotte_data/npy/brandnew_1000plus_label.npy')
...
patience = 16
modelpath='D:/lotte_data/h5/syhj_angel_02.hdf5'
batch_size = 8
...
submission.to_csv('D:/lotte_data/LPD_competition/sub/syhj_angel_03.csv',index=True)
print('==== csv save done ====')
