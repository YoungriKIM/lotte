...
submission.to_csv('C:/lotte_data/LPD_competition/sub/sub_cnn_01-5_2.csv',index=True)
print('==== csv save done ====')
...
# sub_cnn_01-5_2
#26
# loss:  0.5263597965240479
# acc:  0.9112499952316284
