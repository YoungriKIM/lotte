...
patience = 16
modelpath='D:/lotte_data/h5/imgg_04_11.hdf5'
batch_size = 24
...
for imgnumber in range(pred_size):
    ...
    pred_img = tf.keras.applications.resnet.preprocess_input(pred_img)
...
submission.to_csv('D:/lotte_data/LPD_competition/sub/imgg_04_11.csv',index=True)
print('==== csv save done ====')
...
# 04_11
# 앞뒤모두 레스넷 전처리
# loss:  2.7723605632781982
# acc:  0.603301465511322
