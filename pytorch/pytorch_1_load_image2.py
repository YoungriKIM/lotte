...
# 불러올 파일 경로 지정
data_path_train = glob('D:/lotte/LPD_competition/pred/test/*') 

test_loader = data.DataLoader(data_path_train, batch_size=4, shuffle=False)

print(data_path_train.shape)
